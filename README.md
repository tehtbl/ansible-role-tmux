<!-- get id via: ansible-galaxy info tehtbl.tmux | grep -i "id:" -->
...
[Unit tests](https://travis-ci.org/tehtbl/ansible-role-tmux) are done on every commit, pull request, release and periodically.

If you find issues, please register them in [GitHub](https://github.com/tehtbl/ansible-role-tmux/issues)
